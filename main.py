...
csfloat_mapping_file = "data/csfloat_mapping.json"
...
def main():
	...
	csfloat_mapping_svc = csfloat_mapping(csfloat_mapping_file)
	csfloat_marketplace_svc = csfloat_marketplace(csfloat_mapping_svc, csfloat_config.api_key, csfloat_config.base_url)
